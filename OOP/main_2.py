...
vehicle_one = Vehicle("Subaru", "Blue", "Tony", "4", "V6")
vehicle_two = Vehicle("Toyota", "Black", "Mike", "4", "V4")
vehicle_three = Vehicle("BMW", "White", "George", "4", "V8")
vehicle_four = Vehicle("Porsche", "Silver", "Sandy", "4", "V4")

print(vehicle_one.owner)
print(vehicle_two.owner)
print(vehicle_three.owner)
print(vehicle_four.owner)

print(vehicle_one.color)
print(vehicle_two.color)
print(vehicle_three.color)
print(vehicle_four.color)

print(vehicle_one.make)
print(vehicle_two.make)
print(vehicle_three.make)
print(vehicle_four.make)

print(vehicle_one.wheels)
print(vehicle_two.wheels)
print(vehicle_three.wheels)
print(vehicle_four.wheels)
